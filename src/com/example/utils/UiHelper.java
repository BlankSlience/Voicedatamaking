...
public class UiHelper {
	 ...
	 * @param targetFr
	 */
	public static void showFragment(Fragment f, Bundle args, Fragment targetFr) {
		FragmentManager fm = f.getActivity().getSupportFragmentManager();
		showFragment(fm, args, targetFr);
	}
	...
	public static void showFragment(FragmentManager fm, Bundle args, Fragment targetFr) {
		...
		ft.add(R.id.full_screen_stub, targetFr, targetFr.getClass().getName());
