...
import com.example.model.VoiceTrans;
...
public class MainApplication extends Application {
    ...
    public void onCreate() {	
        ...
        AVObject.registerSubclass(Voice.class);
        AVObject.registerSubclass(VoiceTrans.class);
        AVUser.alwaysUseSubUserClass(User.class);
        AVOSCloud.useAVCloudCN();
        AVOSCloud.setDebugLogEnabled(true);
        AVOSCloud.initialize(this, "qSzqpPLqNN3gGWBAd9Q4Tw9a-gzGzoHsz", "KMiGnuOeBKamIoxzqPRbPbtQ");
        INSTANCE = this;
